...
\begin{abstract}
Estimating gene networks in combination with posthoc analysis based on data from malignant tissue is a major challenge in cancer systems biology as it allows us to improve our understanding of disease pathology and eventually identify new drug targets.
Motivated by the need for improving the inherently unstable covariance estimation compounded by noisy gene expression data, we present a hierarchical random covariance model applied as a meta-analysis of gene networks across eleven large-scale gene expression studies of diffuse large B-cell lymphoma (DLBCL).
...
Analysis of genomic data has consequently been an inescapable success by elucidating gene functions and interactions through many different approaches.
Notably, \citep{Agnelli2011, Clarke2013} have successfully applied network analysis in other malignancies.
We wished to interrogate and examine gene-gene interactions in gene expression data of 89 diffuse large B-cell lymphoma (DLBCL) samples from our own lab \citep{DybkaerBoegsted2015}.
Analysing gene-gene interactions using covariances is a simple and well-tested method \citep{Horvath2011} relying on guilt-by-association.
Most methods for analysing gene-gene interactions available, however, often have several shortcomings.
Particularly as in our case, the methods quickly become unstable or even unapplicable when the sample size is small or moderate.
...
% Hmisc::latex(DLBCLdata::DLBCL_overview[,-c(3,6)],
%             file = "",
%             label = "tab:studies",
%             title = "",
%             caption = "Overview of studies used.")
\begin{table}[!tbp]
\caption{Overview of studies used.\label{tab:studies}}
\begin{center}
\begin{tabular}{lllll}
\hline\hline
\multicolumn{1}{l}{}&\multicolumn{1}{c}{GSE}&\multicolumn{1}{c}{Study}&\multicolumn{1}{c}{Author}&\multicolumn{1}{c}{ArrayTypes}\tabularnewline
\hline
1&GSE56315&CHEPRETRO&\citep{DybkaerBoegsted2015}&hgu133plus2\tabularnewline
2&GSE19246&BCCA&Williams et. al.&hgu133plus2\tabularnewline
3&GSE12195&CUICG&Pasqualucci et. al.&hgu133plus2\tabularnewline
4&GSE22895&HMRC&Jima et. al.&hugene10st\tabularnewline
5&GSE31312&IDRC&Visco et. al.&hgu133plus2\tabularnewline
6&GSE10846&LLMPP&Lenz et. al.&hgu133plus2\tabularnewline
7&GSE34171&MDFCI&Monti et. al.&hgu133plus2,hgu133a,hgu133b,snp6\tabularnewline
8&GSE22470&MMML&Richter et. al.&hgu133a\tabularnewline
9&GSE4475&UBCBF&Hummel et. al.&hgu133a\tabularnewline
10&GSE11318&NCI&Lenz. et. al.&hgu133plus2\tabularnewline
\hline
...
The heterogenetiy parameter $\nu$ has no straightforward interpretation partly because the values of $\nu$ which corresponds to a large study heterogenity is dependent on the dimension $p$.
