...
Notably, in mice injected with lymphoma cells, knockout of S100A9 resulted in greater tumor infiltration T cells and less accumulation of MDS cells than that seen in wild-type mice \citep{Cheng2008}.
