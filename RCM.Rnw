...
From the survival analysis the olive green module appeared particularly interesting since it identifies a group of patients with high value of the corresponding eigengene and poor survival, thus making them candidates for experimental therapies. Interestingly, the gene with highest connectivity in this module is S100A8 (MRP8; calgranulin A) and the gene S100A9 (MRP14; calgranulin B) is number 16 further down the connectivity list as compelling research has shown that the S100 family of calcium-binding proteins maintain immunosuppressive MDS cells at the tumor site [xx]. Notably, in mice injected with lymphoma cells, knockout of S100A9 resulted in greater tumor infiltration T cells and less accumulation of MDS cells than that seen in wild-type mice [xx]. The knockout mice had higher rates of tumor rejection and lower tumor size than their wild-type littermates. This result indicates that knock down of these proteins may improve the outcome of immunotherapy strategies in patients with values of the eigengene of the olive green module.
