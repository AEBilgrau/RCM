...
The mean SSEs (and 99\% CI) of these values are seen in panels A and B of Figure \ref{\Sexpr{figure1}} as function of $n_i$.
...
Figure \ref{\Sexpr{figure1}}C shows the computational time in an third scenario for more extreme values of $p$.

\fig{\Sexpr{figure1}}{\textwidth}{
...
From both panels A and B of Figure \ref{\Sexpr{figure1}}, we see that the EM estimation is superior with less variation to that of the approximate MLE and moment estimators.
