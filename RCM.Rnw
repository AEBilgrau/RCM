...
We wished to indentify gene interactions in gene expression data of 89 diffuse large B-cell lymphoma samples from our own lab \citep{DybkaerBoegsted2015} as others \citep{Agnelli2011, Clarke2013} have successfully applied network analysis in other malignancies.
...
Particularly, when the sample size is moderate as with our case, the methods are quickly become unstable or even unapplicable.
...
We now introduce a descriptive statistic analogous to the intra-study correlation coefficient (ICC) \citep{Shrout1979} well known from ordinary meta-analysis to better determine what constitute large values of $\nu$.
...
The ICC might in this sense be utilized in quantifying the reproducibility of the covariance across studies.
