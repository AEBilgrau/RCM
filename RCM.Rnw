...
$(\vPsi, \nu)$.
The latter probably happens with zero probability, but it
cannot be excluded that the maximum found is not global.
...
The ICC might in this sense be utilized in quantifying the reproducbility of the covariance across studies.
